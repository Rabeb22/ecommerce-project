...
const RegisterPage = () => {
  ...
  const handleSubmit = (e) => {
    ...
    } else if (name === 'admin0000123rabeb') {
      dispatch(
        registerUser('admin0000123rabeb'.substr(12), email, password, true)
      );
      // userInfo.isAdmin = true;
    } else {
      dispatch(registerUser(name, email, password, false));
    }
  };
    ...
    <FormContainer>
      <div className="form-inner-container">
        <div className="form-heading">
          <h1 onClick={() => navigate('/login')}>Sign In</h1>
          <h1
            style={{
        ...
        {/* {userInfo.name === 'admin0000123rabeb'
          ? (userInfo.isAdmin = true)
          : null} */}
      </div>
    </FormContainer>
